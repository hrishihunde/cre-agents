...
export const X402AgentABI = [{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"agent","type":"address"},{"indexed":false,"internalType":"string","name":"serviceUrl","type":"string"},{"indexed":false,"internalType":"string","name":"paymentPayload","type":"string"}],"name":"ServiceRequested","type":"event"},{"inputs":[{"internalType":"address","name":"agent","type":"address"},{"internalType":"string","name":"resultData","type":"string"}],"name":"fulfillService","outputs":[],"stateMutability":"nonpayable","type":"function"}] as const
